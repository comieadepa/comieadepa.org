...
export const homeSettingSections: HomeSettingSection[] = [
  {
    ...
    eyebrow: "Abertura",
    description: "Conteúdo da primeira tela do portal: chamada principal, botões e destaque da AGO.",
    fields: [
      ...
      { name: "home_hero_subtitulo", label: "Chamada principal", placeholder: "A primeira convenção assembleiana do Brasil...", type: "textarea" },
      { name: "home_hero_texto", label: "Texto de apoio", placeholder: "Mais de cem anos proclamando o Evangelho...", type: "textarea" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "home_sobre_imagem_url", label: "Imagem principal", placeholder: "/assets/sede-aerea-comieadepa.jpg", type: "image", helper: "Prefira imagem horizontal, em boa resolução." },
