        ...
        <div className="grid gap-5 lg:grid-cols-[auto_1fr] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-3 max-w-4xl leading-7 text-[#5a472c]">
              Área pensada para a equipe de mídia ajustar os blocos institucionais, os textos gerais e a composição visual do hero principal sem sair da edição da home.
            </p>
          </div>
        </div>
      </section>
