        ...
        <section className="mx-auto max-w-6xl px-5 py-16 sm:px-8 lg:py-20">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[.9fr_1.1fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-5 font-serif text-5xl font-black leading-[1.04] text-[#0F3B63] sm:text-7xl">Mesa Diretora</h1>
            </div>
            <p className="text-xl leading-8 text-[#6B7280]">Conheça a liderança da COMIEADEPA</p>
          </div>
        </section>
