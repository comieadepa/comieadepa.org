      ...
      <main className="min-h-screen bg-white px-5 py-16 text-[#1F2937] sm:px-8">
        ...
        <section className="mx-auto max-w-6xl">
          ...
          <div className="mt-10 max-w-3xl">
            <p className="text-sm font-black uppercase tracking-[0.22em] text-[#B8872D]">Galeria</p>
            <h1 className="mt-5 font-serif text-4xl font-black leading-[1.04] text-[#0F3B63] sm:text-6xl">Galeria de Fotos</h1>
            <p className="mt-6 text-lg leading-8 text-[#6B7280]">
              Confira registros fotogrÃ¡ficos de eventos, reuniÃµes, congressos e aÃ§Ãµes institucionais da COMIEADEPA.
            </p>
          </div>
