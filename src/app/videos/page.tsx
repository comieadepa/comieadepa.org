    ...
    <PublicLayout>
      <main className="min-h-screen bg-white text-[#1F2937]">
        <SectionPageHeader
          badge="Vídeos"
          title="Vídeos"
          description="Registros oficiais, shorts, transmissões e coberturas publicados pela equipe de mídia da COMIEADEPA."
          ...
          <div className="mx-auto max-w-6xl">
            {featuredVideo ? (
              ...
              <PublicEmptyState
                ...
                description="Nenhum vídeo publicado no momento. Assim que a equipe cadastrar vídeos ativos no painel, esta página será atualizada automaticamente."
